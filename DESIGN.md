...
การลงทะเบียนใบหน้าด้วยตนเองต้อง preload โมเดลก่อน เปิดด้วยการตรวจบัตร แล้วรับ challenge อายุสั้นแบบผูกบัญชีและใช้ครั้งเดียวเพื่อทำ Liveness protocol v2 ชุดเดียวกับการเช็คชื่อ. Backend เป็นผู้ตรวจเฟรมและใช้ embedding จากเฟรมสุดท้ายที่ผ่านการตรวจเท่านั้น; ห้ามรับภาพนิ่งเดี่ยวจากนักศึกษาและห้ามให้นักศึกษาเขียนทับใบหน้าที่ลงทะเบียนแล้ว. การแก้ไขข้อมูลเดิมเป็นงานควบคุมโดยผู้ดูแลระบบถาวร
